...
export default function Form(props) {
  ...
  return (
    <div className="w-full   h-min flex flex-col items-center justify-center px-4">
      ...
      <div className="max-w-sm w-full text-gray-600 space-y-5">
        <div className="text-center pb-8">
          <div className="mt-5">
            <h3 className="text-green-800 text-2xl font-bold sm:text-3xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 text-white font-medium bg-green-800 hover:bg-green-500 active:bg-indigo-600 rounded-lg duration-150"
          >
            Sign in
          </button>
        </form>
